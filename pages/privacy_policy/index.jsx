...
const PrivacyPolicy = () => {
  return (
    <div className={styles.policymainwrapper}>
        <div className={styles.policyheader}>
            <h1>Welcome to the Afrilearn's Privacy Notice (“Notice”).
        ...
        <div className="row">
          ...
          <div className="col-md-12">
            <div className={`${styles.wrapper} content`}>
              <h3>Welcome to the Afrilearn's Privacy Notice (“Notice”).</h3>
              <p>
              Afrilearn (“We” or “Our”) operates www.mymyafrilearn.com (the “Website”) and Afrilearn Mobile Application (the “Application”). The Website and Application are platforms built to host, manage, and deploy curriculum-relevant content to learners via smartphones and tablets, with marginal concern for internet limitations and costs. Our goal is to provide affordable, world-class education while helping every user achieve superior learning outcomes.
              </p>
              <p>
              This page informs you of Our policies regarding the collection, use and disclosure of your personal data when you visit, access, browse through and/or use Our Website or Mobile Application (“Platform”) and when you use any storage or transmitting device provided by us. Please read carefully, as it’s important for you to understand how We intend to retain and protect the private information you provide us. To protect your privacy, Afrilearn follows different principles in accordance with worldwide practices for user privacy and data protection.
              </p>
              <p>
              Afrilearn values your trust and confidence. We are committed to safeguarding the privacy of your information at all times. If you have any questions about this Notice or Our data protection practices, kindly contact us.
              </p>
              <h3>Contact Details</h3>
              Our full details are:
              <ul>
                <li>
                  Full name of legal entity: Afrilearn International Limited
                </li>
                <li>Email address: care@Myafrilearn.com</li>
                <li>
                  Postal address: 6 Gbemisola Street, Off Allen Avenue, Ikeja,
                  Lagos
                </li>
                <li>Telephone number: +234 802 785 5262, +234 805 154 4949</li>
              </ul>
              <h3>Consent</h3>
              <p>
              By accessing or using Our services or Products, you agree to the collection and use of information in accordance with this Notice. Once you provide consent, you may change your mind and withdraw the consent at any time by contacting us at help@Myafrilearn.com, but please note that consent withdrawal will not affect the lawfulness of any processing carried out before you withdraw your consent.
              </p>
              <h3>The Data We Collect About You</h3>
              <p>
              When signing up on Our Platform, We collect information about every user including children using the Afrilearn product to learn. This information may include:
              </p>
              <p>
              Profile data, such as your name, username or alias, e-mail address, mailing address, location, class (in school), age, and phone number;
              </p>
              <p>
              Financial data, such as your card information, billing address, and payment options may also be required by our payment service providers;
              </p>
              <p>
              Technical information, such as the type of mobile device and internet browser you use, your computer IP address, data about the pages you access, mobile device ID or unique identifier, statistics on page views, standard Web log data, still and moving images, etc;
              </p>
              <p>Marketing data, such as users’ feedback; and</p>
              <p>
                Usage data, such as time spent on Our application, when application was opened, device data and learning statistics (time spent learning, lessons viewed, test scores, etc.). This also includes, but is not limited to, authentication information, microphone and camera sensor data, device data, Android ID, ad usage data, and advertising ID
              </p>
              ...
              <ul>
                ...
                <li>
                  to help us identify and provide the type of service offerings
                  in which you are most interested in;
                </li>
                <li>
                  to enable us create the content most relevant to you and to
                  generally improve Our services;
                </li>
                <li>
                  to make the Platform easier for you to use by not having to
                  enter information more than once;
                </li>
                <li>
                  to manage risk, or to detect, prevent, and/or remediate fraud
                  or other potentially prohibited or illegal activities; and
                </li>
                <li>
              ...
              <p>
              When you register, We create your profile, assign a personal identification number, (your User ID) then send this personal identification number back your email address with an activation link for the activation of your profile. This code is uniquely yours. It is your passport to seamless travel across Our Platform, allowing you to use Our Platform without having to fill out registration forms with information you’ve already provided. Even if you switch computers, you won't have to re-register – just use your User ID to identify yourself.
              </p>
              <h3>Data Security</h3>
              <p>
              We store and process your personal information on Our computers in Nigeria. Where We need to transfer your data to another country, such country must have an adequate data protection law. Please be assured that We have put in place appropriate security measures including but not limited to access controls, firewalls, data encryption, and physical security to prevent your personal data from being lost, altered, disclosed, or otherwise used in an unauthorized way. In addition, We limit access to your personal data to those employees, agents and contractors who have a business need to know. These employees, agents, and contractors have a duty to maintain confidentiality at all times and will only process your personal data according to Our instructions.
              </p>
              <p>
              ...
              <ul>
                <li>
                request access to your personal data (commonly known as a "data subject access request"). This enables you to receive a copy of the personal information We hold about you and check that We are lawfully processing it. Please note that a data subject access request may attract an administrative fee;
                </li>
                <li>
              ...
              <h3>Security</h3>
              <p>
              At Afrilearn, We implement a variety of reasonable security measures to protect the security and integrity of your personal information.
              </p>
              <p>
              ...
              <p>
              We reserve the right to amend or modify this Privacy Policy and if We do so, we will post the changes on this page. It is your responsibility to check the Privacy Policy every time you submit information to us or use Our services. Your use will signify that you agree to any such changes. In the event the purpose is for processing change, or if a revision is material, Afrilearn will notify you via electronic mail or via a pop-up or redirection when you log in to our Platform.
              </p>
              <h3>DISCLAIMER</h3>
              <p>
