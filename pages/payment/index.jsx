...
const payment = ({ test_body }) => {
  ...
  const { paymentPlans, teacherPaymentPlans } = useSelector(
      ...
      <div className={`col-md-5 ${styles.paymentfirstContainer}`}>
        ...
        <div className="">
          <div className="row">
            ...
            <div className={`col-md-10 ${styles.divPoint2}`}>
          ...
          <div className="row">
            <div className={`col-md-1 ${styles.divPoint}`}></div>
            <div className={`col-md-10 ${styles.divPoint2}`}>
              <p>Gain Mastery with Storytelling</p>
            </div>
          </div>
          <div className="row">
            <div className={`col-md-1 ${styles.divPoint}`}></div>
          ...
          <div className="row">
            <div className={`col-md-1 ${styles.divPoint}`}></div>
            <div className={`col-md-10 ${styles.divPoint2}`}>
              <p>Achieve Academic Excellence + More</p>
            </div>
          </div>
        </div>
      </div>
      {userRole === '5fd08fba50964811309722d5' && (
        <div className={`col-md-6 ${styles.paymentSecondContainer}`}>
          <div>
            <div className="row">
              ...
              <div>
                ...
                >
                  ...
                  {courseContext &&
                    courseContext.map((childClass) => (
                      <option placeholder="Select a Role">
                        {childClass.name}
                      </option>
                    ))}
                </select>
            ...
            <h5>Step 2: Select Subscription Length</h5>
          ...
          <div>
            <div className="row">
              ...
              <div>
                ...
                >
                  <option value={'default'}>Select a child</option>
                  {myChildren &&
                    myChildren.map((myChild) => (
                      <option value={'default'}>{myChild.fullName}</option>
                    ))}
                </select>
                <select
                  className={`${styles.pushDown} form-control form-control-sm`}
            ...
            <div className="row">
              ...
              <div>
                ...
                >
                  ...
                  <option placeholder="Select a Role"> Create New Class</option>
                </select>
              </div>
            ...
            <div className={`row ${styles.paymentdurationButtons}`}>
              <div className={` col-md-3 ${styles.durationPayment}`}>
                {!teacher_plans ? (
                  ...
                  teacher_plans.map((teacherPlans) => (
                    <button
                      className={`${styles.paymentwrapper} ${styles.btnpayment}`}
                      ref={priceElement}
                      onClick={() => handleSelect(teacherPlans.amount)}
                    >
                      <div className={styles.durationBold}>
                        {teacherPlans.name}
                      </div>
