...
export const schoolReducer = (state = initialState, { type, payload} ) => {
    switch (type) {
        ...
        case types.DELETE_TEACHER_FAIL:
            return {
                ...state,
                error: payload
        ...
        case types.FETCH_SCHOOL_MEMBER_CLASS_START:
            return {
                loading: true,
            };
        case types.FETCH_SCHOOL_MEMBER_CLASS_SUCCESS:
            return {
                ...state,
                loading: false,
                classMembers: payload
            }
        case types.FETCH_SCHOOL_MEMBER_CLASS_FAIL:
            return {
                ...state,
                error: payload
            }
