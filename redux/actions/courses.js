...
export const fetchSingleLessonInitiate = (lessonId) => {
  return function (dispatch) {
    ...
    axios
      .get(
        `https://afrilearn-backend-01.herokuapp.com/api/v1/lessons/${lessonId}`,
      )
      .then((res) => {
...
export const fetchReconLessonInitiate = (userId, token) => {
  return function (dispatch) {
    ...
    axios
      .post(
        "https://afrilearn-backend-01.herokuapp.com/api/v1/dashboard/recommendations",
        { userId },
        {
          headers: {
            token: token,
  ...
  return function (dispatch) {
    ...
    axios
      ...
      .then((res) => {
        ...
        console.log(
          "Hello from UNICEF reconmendation API after call ===>",
          schoollevel,
          subject,
          lesson,
        );
...
export const fetchActivitiesInitiate = (token) => {
  return function (dispatch) {
    ...
    axios
      .get(
        "https://afrilearn-backend-01.herokuapp.com/api/v1/recents/activities",
        {
          headers: {
            token: token,
            "Content-Type": "application/json",
