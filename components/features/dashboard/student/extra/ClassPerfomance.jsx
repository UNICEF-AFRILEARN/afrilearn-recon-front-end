...
const ClassPerfomance = ({
  ...
  console.log(
    "currentStudent?.data? from classPerformance ===>",
    currentStudent,
  );
    ...
    <div className={styles.performancemainwrapper}>
        ...
        <div className={styles.leftwrapper}>
          <div className={styles.innerwrapper}>
            <div className={styles.studentnamewrapper}>
              ...
              <p>{currentStudent && currentStudent[0]?.userId.email}</p>
              <h3>JSS 1</h3>
            </div>
          </div>
        </div>
      ...
      <div className={styles.progresswrapper}>
        ...
        <div>
          ...
          {showPanel === true &&
            subjectPerformance &&
            subjectPerformance.map((subjectList) => (
              <div className={styles.performancecontentwrapper}>
          ...
          {showPanel === false &&
            ...
            pastQuestionPerformance.map((pastSubject) => (
