...
const ExploreAfrilearn = ({ userRole }) => {
  ...
  return (
    <div
      className={`container-fluid explore-added-class-currection ${styles.exploreAfrilearn}`}
    >
      ...
      <section className={`row ${styles.afterExplore}`}>
        <StatsBox
          title="Star Students, Schools & Teachers love Afrilearn!"
          value={userRole.allUsers}
        />
        <StatsBox title="Practice Questions" value={50664} />
        <StatsBox title="Rich & Ready Class Notes" value={5000} />
        <StatsBox
