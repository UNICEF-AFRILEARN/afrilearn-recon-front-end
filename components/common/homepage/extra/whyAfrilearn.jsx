  ...
  const navigationData = [
    ...
    },
    {
      ...
      content: {
        ...
        description: [
          ...
          'Engage your child for success in school and life️',
          'Transform your child’s life with world-class education',
        ],
        imageURL:
          '/assets/img/common/homepage/f-male-parent-with-children.jpeg',
      },
    },
    {
      id: 3,
    ...
    },
    {
      ...
      content: {
        ...
        imageURL:
          '/assets/img/common/homepage/istockphoto-155344110-1024x1024-transformed.jpeg',
      },
    },
  ]
